  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getProducts.fulfilled, (state, action) => {
          console.log("Fetched products in slice:", action.payload);
        ...
        // Optional: avoid updating state if products are unchanged
        const isSame =
          oldProducts.length === newProducts.length &&
          oldProducts.every((oldProd, i) => oldProd._id === newProducts[i]._id);
